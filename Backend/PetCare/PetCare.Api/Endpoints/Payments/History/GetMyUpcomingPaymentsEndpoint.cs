namespace PetCare.Api.Endpoints.Payments.History;

using System.Security.Claims;
using MediatR;
using PetCare.Application.Dtos.Payments;
using PetCare.Application.Features.Payments.History.GetMyUpcomingPayments;
...
public static class GetMyUpcomingPaymentsEndpoint
{
    ...
    public static void MapGetMyUpcomingPaymentsEndpoint(this WebApplication app)
    {
        ...
        .WithTags("Payments.Payment History")
