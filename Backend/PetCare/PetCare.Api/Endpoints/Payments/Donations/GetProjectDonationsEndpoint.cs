namespace PetCare.Api.Endpoints.Payments.Donations;

using MediatR;
using PetCare.Application.Dtos.Payments;
using PetCare.Application.Features.Payments.Donations.GetProjectDonations;
...
public static class GetProjectDonationsEndpoint
{
    ...
    {
        app.MapGet("/api/payments/donations/project/{projectId:guid}", async (
            Guid projectId,
            IMediator mediator,
